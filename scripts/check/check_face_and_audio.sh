...
INTPUT_AUDIO_DIR="$DATA_PREFIX/$DATASET/videos"                     # 输出目录，用于存储提取的音频信息
INPUT_FACE_DIR="$DATA_PREFIX/$DATASET/videos-crop"                  # 先进行face-crop，作为输入视频目录
